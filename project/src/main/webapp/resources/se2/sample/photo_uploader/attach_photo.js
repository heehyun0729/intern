    ...
    function html5Upload() {	
    	...
    	sUploadURL= '../../../../board/photoUpload'; 	//upload URL
...
// 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/resources/se2/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
