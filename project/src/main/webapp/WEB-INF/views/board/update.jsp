                    ...
                    <form method = "post" id = "writeForm" action="<c:url value='/board/update'/>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-11">
                                <input type="text" name="title" id = "title" value = "${vo.title }" class="form-control mb-30">
                            </div>
                            <div class="col-12">
                            	<textarea name="content" id="ir1" style = "width:100%;height: 400px;" class="form-control mb-30">${vo.content }</textarea>
                            </div>
                        </div>
                    </form>
                </div>
